    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-light-info elevation-4">
            ...
            <a href="/" class="brand-link navbar-gray-dark">
                <img src="/assets/logo-aqua.png" alt="Grey Logo" class="brand-image elevation-3" style="opacity: .8">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <sec:ifAnyGranted roles="ROLE_COVID_ADMINISTRATORS">
                            <li class="nav-item">
                                <g:link controller="Employee" class="nav-link">
                        ...
                        <li class="nav-item">
                            <g:link controller="Screening" class="nav-link">
                        ...
                        <sec:ifAnyGranted roles="ROLE_COVID_ADMINISTRATORS">
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <g:link controller="Import" class="nav-link">
